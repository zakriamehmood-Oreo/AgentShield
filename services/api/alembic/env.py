...
# Override the ini's sqlalchemy.url with DATABASE_URL when set, so this
# works both for bare local dev (falls back to the ini's localhost:5433
# default) and inside Docker (compose sets DATABASE_URL to ...@db:5432/...
# for every container).
